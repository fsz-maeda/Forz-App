...
<body>
	...
	<div class="container">
		...
		<form action="MediaCommentServlet" method="post">
			<div class="form-group">
				...
				<textarea name="comment" id="comment" rows="8"
					placeholder="コメントを入力してください（※改行も反映されます）"><%=request.getParameter("comment") != null ? request.getParameter("comment") : ""%></textarea>
		...
		<div style="margin-top: -54px; width: fit-content;">
			<form action="ArticleContentServlet" method="get">
